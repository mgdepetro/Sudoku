...
if __name__ == '__main__':
	...
	tree = et.parse('test puzzle specifications/3x3_02_solvable.xml')
	...
	#XML Variables
	rows_per_box = root.find('rows_per_box').text
	cols_per_box = root.find('cols_per_box').text
	...
	empty_cell_vals = [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ]
